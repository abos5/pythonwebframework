...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,maxImageSideLength:550000                    //上传图片最大允许的边长，超过会自动等比缩放,不缩放就设置一个比较大的值，更多设置在image.html中
        ...
        ,localDomain:['37wan.com','37wanimg.com']                           //本地顶级域名，当开启远程图片抓取时，除此之外的所有其它域名下的图片都将被抓取到本地,默认不抓取127.0.0.1和localhost
        ...
        //工具栏上的所有的功能按钮和下拉框，可以在new编辑器的实例时选择自己需要的从新定义 'emotion','music', 'attachment', 'map', 'gmap', 'insertframe','insertcode', 'webapp',
        , toolbars:[
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'insertimage',  'scrawl', 'insertvideo','pagebreak', 'template', 'background', '|',
