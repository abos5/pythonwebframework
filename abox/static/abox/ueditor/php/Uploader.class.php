...
class Uploader
{
    ...
    private function upFile( $base64 )
    {
        ...
        $this->fullName = $_baseUrl . $fileName;
        //$this->fullName = $this->getFolder() . $this->getName();        
        $this->fullpath = $filePath = $this->getFolder() . $fileName;
        //echo "||{$file[ "tmp_name" ]}||$filePath ||";
    ...
    private function base64ToImage( $base64Data )
    {
        ...
        $this->fullName =  $_baseUrl. $this->fileName;
        //$this->fullName = $this->getFolder() . '/' . $this->fileName;		        
        $file = $this->getFolder() . '/' . $this->fileName;		
