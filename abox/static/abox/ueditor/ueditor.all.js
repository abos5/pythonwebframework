...
UE.commands['time'] = UE.commands["date"] = {
    execCommand : function(cmd){
        ...
        this.execCommand('insertHtml',cmd == "time" ?
            ...
            (date.getFullYear()+"年"+((date.getMonth()+1)<10 ? "0"+(date.getMonth()+1) : date.getMonth()+1)+"月"+(date.getDate()<10?"0"+date.getDate():date.getDate())+"日"));
    }
};
...
UE.plugins['catchremoteimage'] = function () {
    ...
    var me = this;
    this.setOpt({
        localDomain:["37wanimg.com","37wan.com"],
    ...
    me.addListener("catchRemoteImage", function () {
        ...
        if (remoteImages.length) {
			me.ui.getDom('process').innerHTML='正在保存远程图片,总'+remoteImages.length+'张<img src=\'/static/images/loadinglit.gif\' style=\'vertical-align:middle;\'/>';
			var count = remoteImages.length;		
            catchremoteimage(remoteImages, {
                ...
                success:function (xhr) {
					...
					me.ui.getDom('process').innerHTML='保存远程图片完成，成功：'+success+' 失败：'+error;
                },
                //回调失败，本次请求超时
                error:function () {
    ...
    EditorUI.prototype = {
        ...
        getHtmlTpl:function () {
            return '<div id="##" class="%%">' +
                ...
                '<td id="##_process" class="%%-wordcount"></td>' +				
